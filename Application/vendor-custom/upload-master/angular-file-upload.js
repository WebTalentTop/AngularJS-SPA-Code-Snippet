    ...
    module
        ...
        .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
            function (fileUploaderOptions, $rootScope, $http, $window, $compile) {
                ...
                /*
                 * calls onBeforeItemUpload and uploads file using current transport
                 */
                FileUploader.prototype.uploadInternal = function (item) {

                    var promise = this._onBeforeUploadItem(item);
                    var transport = this.isHTML5 ? '_xhrTransport' : '_iframeTransport';
                    ...
                    promise.then(function (result) {
                        //uploading is allowed, so do it
                        this[transport](item);
                    }.bind(this), function () {
                        //raise error and remove from queue
                        this._onErrorItem(item);
